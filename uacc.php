...
<!DOCTYPE html>
<html>
    <head><title> Unblock Account</title>
...
<div class="w3-top">
  <div class="w3-bar w3-blue w3-card w3-left-align w3-large">
    ...
    <a href="uacc.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">View Blocked Accounts</a>
 ...
 <br><br>
	<?php
            $ins_sql = "SELECT * FROM admindata WHERE st=1";
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Account number is required">
						<input class="input100" type="number_format" name="accno" placeholder="Account Number">
